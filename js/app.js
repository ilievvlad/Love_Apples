(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".models-catalog__slider")) new core(".models-catalog__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".thumbs-card")) {
                const thumbsSwiper = new core(".thumbs-card", {
                    ...
                    preloadImages: false,
                    navigation: {
                        prevEl: ".product-card__inner .slider-arrow_prev",
                        nextEl: ".product-card__inner .slider-arrow_next"
                    }
                });
                new core(".main-card__slider", {
                    modules: [ Thumb ],
                    slidesPerView: 1,
                    spaceBetween: 10,
                    observer: true,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (window.innerWidth) if (targetElement.classList.contains("catalog-header__btn")) targetElement.closest(".catalog-header").classList.toggle("_open"); else if (!targetElement.closest(".catalog-header") && document.querySelector(".catalog-header._open")) document.querySelector(".catalog-header").classList.remove("_open");
